...
/**
 * subtract_largest_coin - fin min number of coins needed to make change
 * @cents: the amount to money to make change for in cents
 *
 ...
 * @argc: size of the argument vetor
